...
func NewProxyTitle() *ProxyTitle {
	titleList := pie.Strings{
		...
		"所谓情怀，也许不过是：曾经好过一场，不知你忘没忘，总之我记得。",
		"但凡未得到，但凡是过去，总是最登对。",
		"人生苦痛的一大来源，是毕生想要被他人了解的渴望。",
		"天下就没有偶然，那不过是化了妆的、戴了面具的必然。",
		"你知道~就算大雨让这座城市颠倒~~公司照样会算你迟到~",
		"爱笑的女生运气不会太差。说实话，如果一个女生运气一直不好，我不知道她怎么笑得出来。",
		"努力不一定会成功，但是不努力一定会很舒服哦！",
		"万不要以为高中单身仅仅是因为学校禁止早恋",
		...
		"你就像夜空中的星星，有你没你都差不多",
		"爱笑的女生，长鱼尾纹的运气一定不会太差",
		"狗是人类最好的朋友，然而狗最好的朋友是屎",
		"知道为什么自古红颜多薄命吗，因为没有人会在意丑的人会活多久",
		"挺起胸膛让那些瞧不起你的人看看，你不仅穷，还丑",
		"我知道这样不好，可是虚度年华真的好过瘾",
		"如果上帝没有给你想要的，不是因为你值得更好的，而是因为你不配",
		"年轻的时候多吃点苦是好事，这样老了你就习惯了。",
		"钱那么靠谱的东西都有假的，何况人说的话呢",
		"世上百分之九十九的事能用钱解决，剩下百分之一的是需要更多的钱解决。",
		"比三观更重要的是五官。",
		"不经历风雨怎么迎接暴风雨。",
		"今年给自己定个小目标存款3万，年底掐指一算还差5万。",
		"只要能用钱解决的事儿，放心吧我一件都解决不了。",
		"撩你不是因为你有多优秀，而是看你的样子就很容易睡。",
		"好人成佛需要九九八十一难，而坏人只需要放下屠刀。",
		"白雪公主的故事告诉我们，七个小屌丝对她再好也不如王子的一个吻。",
		"要走多少路，要看多少风景，才能遇不见你",
		"有的人穷的时候以为有钱了会很快乐，等他真的有钱了，才发现有钱确实很快乐。",
		"你只看到他们挥金如土，却看不到他们背后日进斗金",
		"一个人越炫耀什么，越说明他真的有这个东西",
		"每一个经常失恋的人，都会跟自己说。没关系，只要有耐心，总会有一个人会等着我。阎王爷说：没想到是我吧",
		...
		"以有些人的天赋之高，你拼命努力也没有用。",
		"让一部分人先富起来，然后干掉那些富不起来的，最终实现共同富裕。",
		"强扭的瓜虽然不甜，但是解渴啊！",
		"每天都在用六位数的密码保护着，两位数的存款",
		"在家心疼电费，在公司心疼房租",
		"挣钱是一种能力，花钱是一种技术，我能力有限，技术却很高。",
		"只要你每天坚持自习，认真刻苦，态度端正，忍受孤独，最终的胜利肯定是属于那些考场上发挥好的人。",
		"上帝为你关上了一扇门，然后就去洗洗睡了。",
		...
		"努力不一定成功，但不努力一定很轻松",
		"No, your addiction's not a crime. It's just a smaller part of who. You want to become in the end",
		"别想多了，她根本没拿你当回事",
		"别以为她那么晚回你微信是在 睡觉 吃饭 学习 看书 逛街 遛弯 看视频 看电影 她只是在陪比喜欢你还爱他的人聊天",
		"——你不着急吗 ——着什么急 ——她跟别的异性一起出去吃饭逛街看电影 笑得可开心了 ——那怎么了 和自己喜欢的人在一起有错吗",
